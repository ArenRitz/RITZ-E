  ...
  const generateImg = async () => {
    if(form.prompt) {
      try {
        ...
        const response = await fetch('https://ritz-e.onrender.com/api/v1/dalle', {
          method: 'POST',
          headers: {
  ...
  return (
    <section className='max-w-7xl mx-auto'>
      <div>
        ...
        <p className='mt-2 text-[#666e75] text-[16px] max-w[500px]'> Create imaginative and visually stunning images through DALLE-E AI and share them with the community </p>
      </div>
